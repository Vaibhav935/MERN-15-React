...
const App = () => {
  ...
  const swap = () => {
    setFrom(to);
    setTo(from);
    setAmount(String(convertedAmount));
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1580519542036-c47de6196ba5?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
      }}
    >
